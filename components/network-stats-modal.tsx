                ...
                <div className="p-6 space-y-8">
                    ...
                    >
                        ...
                        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}>
                            ...
                            <Card className="bg-[hsl(var(--surface-1))] border-blue-500/20 p-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-6">
                                        <div>
                                            <div className="text-sm text-[hsl(var(--text-muted))] mb-2">Current Period Progress</div>
                        ...
                        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}>
                            ...
                            <Card className="bg-[hsl(var(--surface-1))] border-[hsl(var(--accent)/0.2)] p-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-6">
                                        <div>
                                            <div className="text-sm text-[hsl(var(--text-muted))] mb-2">Progress to Next Halving</div>
                                            <div className="relative h-4 bg-[hsl(var(--surface-3))] rounded-full overflow-hidden">
                                                <motion.div
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="p-3 bg-[hsl(var(--accent)/0.05)] rounded border border-[hsl(var(--accent)/0.1)] text-xs text-[hsl(var(--accent)/0.7)] leading-relaxed">
                        ...
                        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}>
                            ...
                            <Card className="bg-[hsl(var(--surface-1))] border-purple-500/20 p-6">
                                <MiningStatsChart />
                            </Card>
                        </motion.div>
                    </motion.div>
