...
export function NetworkStats() {
  ...
  if (loading || !difficultyData || !halvingData) {
    return (
      <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 md:left-4 md:translate-x-0 md:top-[8.5rem] md:translate-y-0 z-10 w-[85vw] md:max-w-xs">
  ...
  return (
    <>
      <div className={`absolute left-1/2 -translate-x-1/2 md:left-4 md:translate-x-0 ${isDesktop ? "bottom-[7rem]" : "top-1/2 -translate-y-1/2"} @[@media(min-height:1000px)]:top-1/2 @[@media(min-height:1000px)]:-translate-y-1/2 @[@media(min-height:1000px)]:bottom-auto min-[2000px]:top-1/2 min-[2000px]:-translate-y-1/2 min-[2000px]:bottom-auto z-5`}>
        <motion.div
