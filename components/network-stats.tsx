...
export function NetworkStats() {
  ...
  if (loading || !difficultyData || !halvingData) {
    return (
      <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 md:left-4 md:translate-x-0 z-10 w-[85vw] md:max-w-xs">
  ...
  return (
    <>
      <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 md:left-4 md:translate-x-0 z-5">
        <motion.div
