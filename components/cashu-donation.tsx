      ...
      <Card className="premium-card p-3 text-center w-[232px] min-h-[430px] flex flex-col">
        ...
        {paymentMethod === "onchain" && (
          <>
            ...
            <div className="text-[9px] text-[hsl(var(--text-muted))] mt-2 truncate px-2">
        ...
        {paymentMethod === "lightning" && (
          <>
            ...
            <div className="text-[9px] text-[hsl(var(--text-muted))] mt-2">
              LNURL (any amount)
            </div>
          </>
        )}
        ...
        {paymentMethod === "cashu" && (
          <>
            ...
            {cashuMode === "select" && cashuState === "idle" && (
              <>
                <div className="text-[10px] text-[hsl(var(--text-muted))] mb-2">Choose option</div>
                <div className="flex flex-col gap-2">
                  <Button
                    onClick={() => setCashuMode("invoice")}
                    size="sm"
                    variant="ghost"
                    className="w-full premium-button-accent px-2 py-5 h-auto text-[11px] flex flex-col items-center justify-center gap-1"
                  >
            ...
            {cashuMode === "invoice" && cashuState === "idle" && (
              <>
                <Button
                  ...
                  size="sm"
                  variant="ghost"
                  className="mb-2 premium-button px-2 py-0.5 h-6 text-[10px]"
                >
            ...
            {cashuMode === "invoice" && cashuState === "pending" && (
              <>
                <div className="text-[10px] text-[hsl(var(--text-muted))] mb-1.5">
                ...
                <div className="flex items-center justify-center gap-1.5 text-[10px] text-[hsl(var(--text-muted))] mb-2">
                ...
                <Button
                  ...
                  size="sm"
                  variant="ghost"
                  className="w-full premium-button-accent px-1.5 py-0.5 h-6 text-[10px] mb-1.5"
                >
                ...
                <Button
                  ...
                  size="sm"
                  variant="ghost"
                  className="w-full premium-button px-1.5 py-0.5 h-6 text-[10px]"
                >
            ...
            {cashuState === "paid" && (
              <>
                ...
                <Button
                  ...
                  size="sm"
                  variant="ghost"
                  className="w-full premium-button-accent px-1.5 py-0.5 h-7 text-[11px]"
                >
            ...
            {cashuState === "error" && (
              <>
                <div className="flex flex-col items-center justify-center py-3">
                  ...
                  <div className="text-[10px] text-[hsl(var(--text-muted))]">{error}</div>
                </div>
            ...
            {cashuMode === "paste" && !pasteSuccess && !pasteLoading && (
              <>
                ...
                <div className="text-[10px] text-[hsl(var(--text-muted))] mb-2">Paste Cashu token</div>
                ...
                <div className="flex gap-1.5 mb-2">
                  <Button
                    ...
                    size="sm"
                    variant="ghost"
                    className="flex-1 premium-button-accent px-1.5 py-0.5 h-7 text-[10px]"
                  >
            ...
            {cashuMode === "paste" && pasteLoading && (
              <div className="flex flex-col items-center justify-center py-4">
                <Loader2 className="w-8 h-8 animate-spin text-[hsl(var(--accent))] mb-2" />
                <div className="text-[hsl(var(--text-muted))] text-[11px]">Redeeming token...</div>
                <div className="text-[hsl(var(--text-muted))] text-[9px] mt-1">This may take a moment</div>
              </div>
            )}
