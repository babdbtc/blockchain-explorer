  ...
  theme: {
  	extend: {
		...
		keyframes: {
			...
			'glow-pulse': {
				'0%, 100%': {
					boxShadow: '0 0 8px hsl(var(--accent) / 0.1), 0 0 15px hsl(var(--accent) / 0.05)',
				},
				'50%': {
					boxShadow: '0 0 16px hsl(var(--accent) / 0.25), 0 0 30px hsl(var(--accent) / 0.12)',
				},
			},
			'value-flash': {
				'0%': { backgroundColor: 'transparent' },
				'20%': { backgroundColor: 'hsl(var(--accent) / 0.18)', borderRadius: '4px' },
